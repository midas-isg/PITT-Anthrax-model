...
public class TreatedProdToSuccessfullyTreatedFul extends
	...
	public TreatedProdToSuccessfullyTreatedFul(String name,
		...
		// efficacy.setRunTimeValueInternal(ParameterConstants.FUL_TREATMENT_EFFICACY);
