...
public class UntreatedToSuccessfullyTreatedProd extends
		AbstractTransitionFunction {

	double efficacy = Parameters.getProdTreatmentEfficacy();

	public UntreatedToSuccessfullyTreatedProd(String name, IStateNode fromNode,
		...
		efficacy =  Parameters.getProdTreatmentEfficacy();
	}
	...
	public double getP(int t) {
		if ((fromNode.getNumberThatHaveBeenInNodeForNHours(t) > 0.0)
			...
			// we are not implementing a capacity
